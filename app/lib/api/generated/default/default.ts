 ...
 */
export const generateGeneStructureSvgApiPyGenerateGeneStructureSvgPost = async (geneStructureRequest: GeneStructureRequest, options?: Parameters<typeof customFetch>[1]): Promise<generateGeneStructureSvgApiPyGenerateGeneStructureSvgPostResponse> => {
 ...
 */
export const generateMultiGeneStructureSvgApiPyGenerateMultiGeneStructureSvgPost = async (multiGeneStructureRequest: MultiGeneStructureRequest, options?: Parameters<typeof customFetch>[1]): Promise<generateMultiGeneStructureSvgApiPyGenerateMultiGeneStructureSvgPostResponse> => {
...
return customFetch<generateMultiGeneStructureSvgApiPyGenerateMultiGeneStructureSvgPostResponse>(getGenerateMultiGeneStructureSvgApiPyGenerateMultiGeneStructureSvgPostUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(multiGeneStructureRequest)
  }
);}
 ...
 */
export const generateRegionGeneStructureSvgApiPyGenerateRegionGeneStructureSvgPost = async (regionGeneStructureRequest: RegionGeneStructureRequest, options?: Parameters<typeof customFetch>[1]): Promise<generateRegionGeneStructureSvgApiPyGenerateRegionGeneStructureSvgPostResponse> => {
...
return customFetch<generateRegionGeneStructureSvgApiPyGenerateRegionGeneStructureSvgPostResponse>(getGenerateRegionGeneStructureSvgApiPyGenerateRegionGeneStructureSvgPostUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(regionGeneStructureRequest)
  }
);}
